...
exports.createAmplifyGeocoder = exports.AmplifyGeocoderAPI = void 0;
/* eslint-disable @typescript-eslint/explicit-module-boundary-types */
const geo_1 = require("@aws-amplify/geo");
const maplibre_gl_geocoder_1 = __importDefault(require("@maplibre/maplibre-gl-geocoder"));
const maplibre_gl_1 = __importDefault(require("maplibre-gl"));
const createDefaultIcon_1 = require("./createDefaultIcon");
exports.AmplifyGeocoderAPI = {
    forwardGeocode: (config) => __awaiter(void 0, void 0, void 0, function* () {
        const features = [];
        try {
            const data = yield geo_1.Geo.searchByText(config.query, {
    ...
    reverseGeocode: (config) => __awaiter(void 0, void 0, void 0, function* () {
        const features = [];
        try {
            const data = yield geo_1.Geo.searchByCoordinates(config.query, {
                maxResults: config.limit,
            });
    ...
    getSuggestions: (config) => __awaiter(void 0, void 0, void 0, function* () {
        const suggestions = [];
        try {
            const response = yield geo_1.Geo.searchForSuggestions(config.query, {
    ...
    searchByPlaceId: (config) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const place = yield geo_1.Geo.searchByPlaceId(config.query);
            if (place) {
...
function createAmplifyGeocoder(options) {
    return new maplibre_gl_geocoder_1.default(exports.AmplifyGeocoderAPI, Object.assign({ maplibregl: maplibre_gl_1.default, showResultMarkers: { element: (0, createDefaultIcon_1.createDefaultIcon)() }, marker: { element: (0, createDefaultIcon_1.createDefaultIcon)() }, 

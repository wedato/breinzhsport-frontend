...
class AmplifyMapLibreRequest {
    constructor(currentCredentials, region) {
        this.refreshCredentials = () => __awaiter(this, void 0, void 0, function* () {
            try {
                this.credentials = yield core_1.Credentials.get();
            }
            catch (e) {
        ...
        this.transformRequest = (url, resourceType) => {
            ...
            if (urlObject.hostname.endsWith(".amazonaws.com")) {
                ...
                urlObject.searchParams.append('x-amz-user-agent', encodeURIComponent((0, utils_1.urlEncodePeriods)((0, core_1.getAmplifyUserAgent)())));
                return {
                    url: core_1.Signer.signUrl(urlObject.href, {
...
AmplifyMapLibreRequest.createMapLibreMap = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const amplifyRequest = new AmplifyMapLibreRequest(yield core_1.Credentials.get(), region || defaultMap.region);

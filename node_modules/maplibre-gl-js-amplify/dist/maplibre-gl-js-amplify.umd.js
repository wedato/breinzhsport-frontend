(function (global, factory) {
    ...
    const AmplifyGeocoderAPI = {
        ...
        getSuggestions: (config) => __awaiter$2(void 0, void 0, void 0, function* () {
            const suggestions = [];
            try {
        ...
        searchByPlaceId: (config) => __awaiter$2(void 0, void 0, void 0, function* () {
            let feature = undefined;
            try {
                const place = yield geo.Geo.searchByPlaceId(config.query);
                if (place) {

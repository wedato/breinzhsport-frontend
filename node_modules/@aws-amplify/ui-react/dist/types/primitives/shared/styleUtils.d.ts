...
export declare const convertGridSpan: (spanValue?: GridItemStyleProps['rowSpan'] | GridItemStyleProps['columnSpan']) => GridItemStyleProps['row'] | GridItemStyleProps['column'] | null;
